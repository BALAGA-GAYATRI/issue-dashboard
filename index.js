...
define("config", ["require", "exports", "analytics", "js-yaml", "fs"], function (require, exports, analytics_1, yaml, fs) {
    "use strict";
...
define("date", ["require", "exports", "dayjs", "dayjs/plugin/utc", "dayjs/plugin/customParseFormat"], function (require, exports, dayjs_1, utc_1, customParseFormat_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    dayjs_1 = __importDefault(dayjs_1);
    utc_1 = __importDefault(utc_1);
...
// functions.
define("evaluate", ["require", "exports", "date"], function (require, exports, date_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Evaluate {
...
define("analytics", ["require", "exports", "evaluate"], function (require, exports, evaluate_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// as HTML.
define("render_html", ["require", "exports", "analytics", "fs"], function (require, exports, analytics_2, fs) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    fs = __importStar(fs);
    ...
    class HtmlRenderer {
        ...
        static renderGraphWidget(widget) {
            ...
            for (let element of widget.elements) {
                if (!(element instanceof analytics_2.NumberWidget)) {
        ...
        static renderTableCell(type, cell) {
            let html = new Array();
            if (!(cell instanceof analytics_2.NumberWidget) && !(cell instanceof analytics_2.StringWidget)) {
            ...
            let url = cell.url;
            let align = null;
            if (cell instanceof analytics_2.StringWidget) {
                align = cell.align;
            }
...
`);
            ...
            for (let section of analytics.sections) {
                ...
                for (let widget of section.widgets) {
                    if (widget instanceof analytics_2.NumberWidget) {
                    ...
                    if (widget instanceof analytics_2.StringWidget) {
                        html.push(HtmlRenderer.renderStringWidget(widget));
                    }
                    else if (widget instanceof analytics_2.GraphWidget) {
                        html.push(HtmlRenderer.renderGraphWidget(widget));
                    }
                    else if (widget instanceof analytics_2.TableWidget) {
...
// data as markdown.
define("render_markdown", ["require", "exports", "analytics", "fs"], function (require, exports, analytics_3, fs) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    fs = __importStar(fs);
    class MarkdownRenderer {
        ...
        static renderGraphWidget(widget) {
            ...
            let max = 0;
            for (let element of widget.elements) {
                if (!(element instanceof analytics_3.NumberWidget)) {
                    throw new Error(`GraphWidget element did not evaluate to a NumberWidget (is a ${widget.constructor.name})`);
                }
                let num = element;
                if (typeof num.value != 'number') {
        ...
        static renderTableCell(widget) {
            if (!(widget instanceof analytics_3.NumberWidget) && !(widget instanceof analytics_3.StringWidget)) {
        ...
        static renderTableWidget(widget) {
            ...
            line.push('|');
            for (let i = 0; i < columns; i++) {
                let align = (widget.headers != null && i < widget.headers.length && widget.headers[i] instanceof analytics_3.StringWidget) ? widget.headers[i].align : null;
                if (align == 'left') {
                    line.push(':--');
                }
        ...
        static renderAnalytics(analytics) {
            ...
            for (let section of analytics.sections) {
                ...
                let showingNumberWidgets = false;
                for (let widget of section.widgets) {
                    if (widget instanceof analytics_3.NumberWidget) {
                        // Group the number widgets together
                        if (!showingNumberWidgets) {
                            md.push('| Query |  |');
                            md.push('|:------|-:|');
                    ...
                    if (widget instanceof analytics_3.StringWidget) {
                        md.push(MarkdownRenderer.renderStringWidget(widget));
                    }
                    else if (widget instanceof analytics_3.GraphWidget) {
                        md.push(MarkdownRenderer.renderGraphWidget(widget));
                    }
                    else if (widget instanceof analytics_3.TableWidget) {
...
define("render", ["require", "exports", "render_html", "render_markdown"], function (require, exports, render_html_1, render_markdown_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Renderer {
...
define("main", ["require", "exports", "@actions/core", "@actions/github", "config", "analytics", "render"], function (require, exports, core, github_1, config_1, analytics_4, render_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    async function run() {
        try {
            ...
            const result = await analytics_4.Analytics.evaluate(config, github);
